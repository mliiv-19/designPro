...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('new', 'Новая'), ('in-progress', 'Принято в работу'), ('complete', 'Выполнено')], default='new', max_length=20, verbose_name='Статус')),
                ('title', models.CharField(max_length=100, verbose_name='Название заявки')),
                ('description', models.TextField(verbose_name='Описание')),
                ('image', models.ImageField(null=True, upload_to='design_requests/', validators=[project.models.validate_userrequest_image_extension], verbose_name='Изображение')),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('design_image', models.ImageField(null=True, upload_to='design_img/', validators=[project.models.validate_userrequest_image_extension])),
